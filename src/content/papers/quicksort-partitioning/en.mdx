...
Partitioning is the core operation of quicksort. Two classical schemes exist: Hoare's [@Hoare1962] and Lomuto's. The expected-case analysis
of the overall algorithm is due to Sedgewick [@Sedgewick1977].
