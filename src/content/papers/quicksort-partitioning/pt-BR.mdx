...
language: 'pt-BR'
status: 'published'
bibliography: ./src/content/papers/quicksort-partitioning/references.bib
---

import { Theorem, Definition, Proof, Sidenote, Figure } from '../../../components/mdx';

O particionamento é a operação central do quicksort. Existem dois esquemas clássicos: o de Hoare [@Hoare1962] e o de Lomuto. A análise do
caso esperado do algoritmo como um todo é de Sedgewick [@Sedgewick1977].
