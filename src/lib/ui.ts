...
const strings = {
  ...
  'nav.open-source': { en: 'Open Source', 'pt-BR': 'Open Source' },
  ...
  'listing.open-source.title': { en: 'Open Source', 'pt-BR': 'Open Source' },
  'listing.open-source.description': {
    en: 'Libraries I maintain and patches I have upstreamed.',
    'pt-BR': 'Libraries que eu mantenho e patches que enviei upstream.',
  },
  'open-source.libraries.title': { en: 'Libraries', 'pt-BR': 'Libraries' },
  'open-source.contributions.title': { en: 'Contributions', 'pt-BR': 'Contribuições' },
  'open-source.libraries.aria': { en: 'Authored libraries', 'pt-BR': 'Libraries de autoria própria' },
  'open-source.contributions.aria': { en: 'Upstream contributions', 'pt-BR': 'Contribuições upstream' },
  'kind.library': { en: 'Library', 'pt-BR': 'Library' },
  'pr.state.merged': { en: 'Merged', 'pt-BR': 'Merged' },
  'pr.state.open': { en: 'Open', 'pt-BR': 'Open' },
